...
{
    public partial class WordGap : UserControl
    {
        ...
        static WordGap()
        {
            try
            {
                ...
                try
                {
                    ...
                    st = Assembly.GetExecutingAssembly().GetManifestResourceStream("DependencyEdit.Properties.Scissor24.cur");
